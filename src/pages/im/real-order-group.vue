...
.header { padding: 20rpx 32rpx; background: #fff; border-bottom: 1rpx solid var(--yb-border); }.title,.meta,.sender { display:block; }.title{font-size:30rpx;font-weight:600}.meta,.sender{font-size:22rpx;color:#86909c;margin-top:4rpx}.messages{flex:1;min-height:0;padding:20rpx 24rpx}.row{display:flex;flex-direction:column;margin-bottom:20rpx}.row.right{align-items:flex-end}.row.center{align-items:center}.bubble{max-width:75%;padding:16rpx 20rpx;border-radius:var(--yb-radius-md);background:#fff;color:#1d2129;font-size:26rpx;word-break:break-word;border:1rpx solid var(--yb-border)}.bubble.right{background:var(--yb-brand);border-color:var(--yb-brand);color:#fff}.bubble.center{background:#f1f1ee;color:#717784;font-size:22rpx}.empty{text-align:center;color:#86909c;padding:60rpx 0}
.realtime-notice{display:flex;align-items:center;justify-content:space-between;gap:16rpx;padding:12rpx 32rpx;background:#fff6e8;color:#a85a00;font-size:22rpx}.retry{color:var(--yb-brand)}.delivery,.recall{font-size:20rpx;color:#86909c;margin-top:4rpx}.recall{color:var(--yb-brand)}.message-image{display:block;max-width:420rpx;border-radius:12rpx}.voice-message{display:block;min-width:150rpx}.composer{display:flex;align-items:center;gap:12rpx;padding:16rpx 24rpx;padding-bottom:calc(16rpx + env(safe-area-inset-bottom));background:#fff;border-top:1rpx solid var(--yb-border)}.image-picker,.voice-picker{flex-shrink:0;color:var(--yb-brand);font-size:24rpx}.image-picker.disabled,.voice-picker.disabled{color:#c9cdd4}.voice-picker.recording{color:#d4380d}.input{flex:1;min-width:0;height:64rpx;padding:0 24rpx;box-sizing:border-box;border-radius:32rpx;background:#f2f2ef;font-size:26rpx}.send{padding:16rpx 28rpx;border-radius:32rpx;background:var(--yb-brand);color:#fff;font-size:26rpx;font-weight:600}.send.disabled{background:#c9cdd4}
</style>
